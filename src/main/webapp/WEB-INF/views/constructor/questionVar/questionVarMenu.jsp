...
<head>
    ...
    <script src="/public/js/constructor/questionVarMenu/service/service.js" type="text/javascript" defer></script>
    <script src="/public/js/constructor/questionVarMenu/util/util.js" type="text/javascript" defer></script>
    <script src="/public/js/constructor/questionVarMenu/view/view.js" type="text/javascript" defer></script>
</head>

<body onload="downloadPage(${questionKit_id})">
...
<div class="view-box">
    <div class="menu">
        ...
        <h4>Методика: <span id="questionKit_name">${questionKit_name}</span></h4>
                        ...
                        <div class="form-group has-feedback" id="divId">
                            <div class="col-xs-6">
                                <div class="input-group">
                                    <input type="hidden" class="form-control"  name="superQuestionVarId" value="null" required>
                ...
                <form role="form" class="form-horizontal" id="putEntity">
                    ...
                    <div class="changeDivId hidden">
                        <div class="form-group has-feedback">
                            <div class="col-xs-6">
                                <div class="input-group">
                                    <input type="text" class="form-control"  name="superQuestionVarId" id="superQuestionVarIdUpdate"  required>
