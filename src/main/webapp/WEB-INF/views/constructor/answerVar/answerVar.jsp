...
<head>
    ...
    <script src="/public/js/constructor/answerVar/service/service.js" type="text/javascript"></script>
    <script src="/public/js/constructor/answerVar/ajax/ajax.js" type="text/javascript"></script>
    <script src="/public/js/constructor/answerVar/view/view.js" type="text/javascript"></script>
