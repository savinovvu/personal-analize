...
<head>
    ...
    <script src="/public/js/constructor/answerKit/service/service.js" type="text/javascript"></script>
    <script src="/public/js/constructor/answerKit/ajax/ajax.js" type="text/javascript"></script>
    <script src="/public/js/constructor/answerKit/view/view.js" type="text/javascript"></script>
