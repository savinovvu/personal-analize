...
<head>
    ...
    <script src="/public/js/constructor/questionSub/service/service.js" type="text/javascript" defer></script>
    <script src="/public/js/constructor/questionSub/view/view.js" type="text/javascript" defer></script>
</head>

<body onload="downloadPage(${id})">
...
<div class="view-box">
    <p style="font-size: 20px">Список подвопросов для: ${question}</p>
    <div class="menu">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Добавление/Обновление подвопроса</h4>
            </div>
