...
<head>
    ...
    <script src="/public/js/constructor/questionSub/service/service.js" type="text/javascript"></script>
    <script src="/public/js/constructor/questionSub/view/view.js" type="text/javascript"></script>
</head>
