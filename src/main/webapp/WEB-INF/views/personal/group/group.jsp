...
<head>
    ...
    <script src="/public/js/personal/group/service/groupService.js" type="text/javascript" defer></script>
    <script src="/public/js/personal/group/view/groupView.js" type="text/javascript" defer></script>
